...
%GO% "wget -q https://dl.google.com/linux/direct/chrome-remote-desktop_current_amd64.deb ; apt-get -y install seamonkey-mozilla-build ./chrome-remote-desktop_current_amd64.deb /tmp/Kali-xRDP/deb/zenmap_7.80+dfsg1-1build1_all.deb /tmp/Kali-xRDP/deb/python-gtk2_2.24.0-5.1+b1_amd64.deb /tmp/Kali-xRDP/deb/python-gobject-2_2.28.6-13+b1_amd64.deb /tmp/Kali-xRDP/deb/python-numpy_1.16.2-1_amd64.deb /tmp/Kali-xRDP/deb/python-cairo_1.16.2-1+b1_amd64.deb /tmp/Kali-xRDP/deb/libffi6_3.2.1-9_amd64.deb" > "%TEMP%\Kali-xRDP\%TIME:~0,2%%TIME:~3,2%%TIME:~6,2% Additional Components.log" 2>&1
...
%GO% "cp -Rp /tmp/Kali-xRDP/dist/* / ; cp -Rp /tmp/Kali-xRDP/dist/etc/skel/.* /root ; update-rc.d -f xrdp enable S 2 3 4 5 ; update-rc.d -f inetutils-syslogd enable S 2 3 4 5 ; update-rc.d -f ssh enable S 2 3 4 5 ; update-rc.d -f avahi-daemon enable S 2 3 4 5 ; cd /tmp" >NUL 2>&1 
