...
%GO% "wget https://dl.google.com/linux/direct/chrome-remote-desktop_current_amd64.deb -O /tmp/chrome-remote-desktop_current_amd64.deb ; apt-get -y install seamonkey-mozilla-build /tmp/chrome-remote-desktop_current_amd64.deb nmap liblinear-tools liblinear-dev ncat ndiff /tmp/Kali-xRDP/deb/zenmap_7.92-1_all.deb /tmp/Kali-xRDP/deb/python-gtk2_2.24.0-5.1_amd64.deb /tmp/Kali-xRDP/deb/python-gobject-2_2.28.6-14ubuntu1_amd64.deb /tmp/Kali-xRDP/deb/python-numpy_1.16.5-2ubuntu7_amd64.deb /tmp/Kali-xRDP/deb/python-cairo_1.16.2-2ubuntu2_amd64.deb /tmp/Kali-xRDP/deb/libffi7_3.3-6_amd64.deb /tmp/Kali-xRDP/deb/python-glade2_2.24.0-5.1_amd64.deb python2" > "%TEMP%\Kali-xRDP\%TIME:~0,2%%TIME:~3,2%%TIME:~6,2% Additional Components.log" 2>&1
